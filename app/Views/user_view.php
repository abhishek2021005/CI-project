...
<div class="container mt-4">
  ...
  <div class="d-flex justify-content-end " style="margin:25px 0px 25px 25px;">
    <a class="btn btn-primary " href="/profile" role="button">Homepage</a>
  </div>
